...
local function readSettings(composite_float_values)
	settings.green_start = parseSetting(composite_float_values, 1, 0, MAX_PRESSURE, 0)
	settings.green_end = parseSetting(composite_float_values, 2, 0, MAX_PRESSURE, 0)
	settings.red_1_start = parseSetting(composite_float_values, 3, 0, MAX_PRESSURE, 0)
	settings.red_1_end = parseSetting(composite_float_values, 4, 0, MAX_PRESSURE, 0)
	settings.red_2_start = parseSetting(composite_float_values, 5, 0, MAX_PRESSURE, 0)
	settings.red_2_end = parseSetting(composite_float_values, 6, 0, MAX_PRESSURE, 0)
...
function onTick(_)
	...
	local _pressure, pressure_get_ok = component.getInputLogicSlotFloat(PRESSURE_INPUT_SLOT)
